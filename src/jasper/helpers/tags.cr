module Jasper::Helpers::Tags
  ...
  def input_field_tag(type : Symbol, options : Hash(String | Symbol, String | Bool | Symbol | Int32))
    input_field_tag_string(type: type, options: options)
  end

  def input_field_tag_string(type : Symbol, options : Hash(String | Symbol, String | Bool | Symbol | Int32))
  ...
  def content_tag(name : Symbol, content : String, options : Hash(String | Symbol, String | Bool | Symbol | Int32) )
    content_tag(name: name, options: options) do
      content
    end
  end

  def content_tag(name : Symbol, options : Hash(String | Symbol, String | Bool | Symbol | Int32), &block)
